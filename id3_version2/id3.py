...
def calculate_entropy(df_set, output_attrib, output_classes):
    '''
...
def calculate_gain(df_set, set_entropy, partition_name, output_attrib, output_classes):
    '''
    Gain(X,T) = H(T) - H(X,T)
    '''
    ...
    part_entropy = [calculate_entropy(df_set[df_partition == t_class], output_attrib, output_classes) for t_class in part_classes]
